...
function (_Component) {
  ...
  function _default() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "changer", function () {
      _this.state.num <= 2 ? _this.setState({
  ...
  _createClass(_default, [{
    ...
    value: function render() {
      ...
      }, "Change"), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("h2", null, this.state.everything[this.state.num]), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("ul", null, getPosts().map(function (post) {
...
//# sourceMappingURL=index.js.07e674fd985fc9f00f33.hot-update.js.map